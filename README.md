...
.SYNOPSIS
    ...
    Latest credit to Niclas Ã–berg for updating the script to support BizTalk Server 2020 CU4.
...
.NOTES
    Author: Thomas Canter, Sandro Pereira, Michael Stepensen, Niclas Ã–berg
