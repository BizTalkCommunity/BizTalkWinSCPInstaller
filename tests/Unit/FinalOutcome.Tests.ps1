<#
.SYNOPSIS
Unit tests for final execution outcome classification helper.

.DESCRIPTION
Validates outcome classification for success, dry-run, prerequisite failure,
installation failure, and unresolved/unknown terminal states.
#>
